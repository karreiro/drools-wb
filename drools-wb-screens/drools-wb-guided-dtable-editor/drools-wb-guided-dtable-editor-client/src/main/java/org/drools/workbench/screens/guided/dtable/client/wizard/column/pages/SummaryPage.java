...
public class SummaryPage extends AbstractDecisionTableColumnPage {
    ...
    public void init( final GuidedDecisionTableColumnWizard wizard ) {
        metaDataColumnWizardPlugin.init( wizard );
    ...
    private ListBox getColumnTypeSelector() {
        return new ListBox() {{
            ...
            addItem( GuidedDecisionTableConstants.INSTANCE.AddNewMetadataOrAttributeColumn(), NewColumnTypes.METADATA_ATTRIBUTE.name() );
    ...
    private void openPage( final String type ) {
        ...
        if ( type.equals( NewColumnTypes.METADATA_ATTRIBUTE.name() ) ) {
            pages.addAll( metaDataColumnWizardPlugin.getPages() );
        } else if ( type.equals( NewColumnTypes.CONDITION_SIMPLE.name() ) ) {
            pages.addAll( attributeColumnWizardPlugin.getPages() );
        } else if ( type.equals( NewColumnTypes.CONDITION_SIMPLE.name() ) ) {
