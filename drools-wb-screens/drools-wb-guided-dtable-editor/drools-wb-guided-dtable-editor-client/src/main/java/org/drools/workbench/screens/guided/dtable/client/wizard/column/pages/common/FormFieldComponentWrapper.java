...
public class FormFieldComponentWrapper {

    final Label label;
    final Div container;

    public FormFieldComponentWrapper( final Label label,
                                      final Div container ) {
        this.label = label;
        this.container = container;
    }

    public void setup( final Boolean canSetup,
        ...
        addWidgetToContainer( widget.get() );
    }
