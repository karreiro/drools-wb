...
public class PatternWrapper {
    ...
    public PatternWrapper(final String metadataKey) {
        final String[] metadata = metadataKey.split("\\s");

        this.factType = metadata[0];
        this.boundName = metadata[1];
        this.negated = Boolean.parseBoolean(metadata[2]);
    }
