...
@Dependent
public class FieldWizardPage extends AbstractDecisionTableColumnPage<ConditionColumnWizardPlugin> {
    ...
    public interface View extends UberView<FieldWizardPage> {
