...
@Dependent
public class OperatorWizardPage extends AbstractDecisionTableColumnPage<ConditionColumnWizardPlugin> {
    ...
    public String getOperator() {
        return canSetOperator() ? plugin().getEditingCol().getOperator() : "";
    }

    public void setOperator( final String selectedValue ) {
        plugin().getEditingCol().setOperator( selectedValue );
