...
public class AttributeColumnWizardPage extends AbstractDecisionTableColumnPage {
    ...
    private FormStyleLayout content;
    ...
    public void initialise() {
        ...
        this.title = new Label( "UAhusahuuhsauh" );
        ...
        this.content.addRow( title );
    }

    private void setMetadataPanel() {
        content = new FormStyleLayout();
    ...
    private ClickHandler getMetadataHandler() {
