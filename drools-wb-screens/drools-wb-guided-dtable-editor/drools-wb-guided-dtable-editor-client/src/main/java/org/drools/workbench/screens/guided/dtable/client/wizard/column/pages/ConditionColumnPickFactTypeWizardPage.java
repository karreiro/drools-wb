...
public class ConditionColumnPickFactTypeWizardPage implements WizardPage {
...
//            hide();
    ...
    public ConditionColumnPickFactTypeWizardPage( final NewGuidedDecisionTableColumnWizard wizard,
