...
import org.drools.workbench.screens.guided.dtable.client.wizard.column.pages.common.FormFieldWrapper;
...
public class ValueOptionsPageView extends Composite implements ValueOptionsPage.View {
    ...
    private void setupCepOperators() {
        final FormFieldWrapper wrapper = new FormFieldWrapper(cepWindowOperatorsLabel,
    ...
    private void setupDefaultValue() {
        final FormFieldWrapper wrapper = new FormFieldWrapper(defaultValueLabel,
    ...
    private void setupLimitedValue() {
        final FormFieldWrapper wrapper = new FormFieldWrapper(limitedValueLabel,
    ...
    private void setupBinding() {
        final FormFieldWrapper wrapper = new FormFieldWrapper(bindingLabel,
                                                              bindingContainer);
