...
public class ActionUpdateFactPage extends AbstractDecisionTableColumnPage {
    ...
    private ActionSetFieldCol52 originalCol;
    ...
    public ActionUpdateFactPage( final GuidedDecisionTableColumnWizard wizard,
                                 final GuidedDecisionTableView.Presenter presenter ) {

        ActionSetFieldCol52 column = null;

        switch ( presenter.getModel().getTableFormat() ) {
            case EXTENDED_ENTRY:
                column = new ActionSetFieldCol52();
                break;
            case LIMITED_ENTRY:
                column = new LimitedEntryActionSetFieldCol52();
                break;
        }
...
//        this.refreshGrid = refreshGrid;
        ...
        content.addAttribute( new StringBuilder( GuidedDecisionTableConstants.INSTANCE.Fact() ).append( GuidedDecisionTableConstants.COLON ).toString(),
                      pattern );
        ...
        content.addAttribute( new StringBuilder( GuidedDecisionTableConstants.INSTANCE.UpdateEngineWithChanges() ).append( GuidedDecisionTableConstants.COLON ).toString(),
                      doUpdate() );
...
//        add( footer );
    ...
    public String getTitle() {
        return GuidedDecisionTableConstants.INSTANCE.ColumnConfigurationSetAFieldOnAFact();
    }
...
//        footer.enableCancelButton( enabled );
    ...
    public ActionSetFieldCol52 getEditingCol() {
        return editingCol;
    }
    ...
    public ActionSetFieldCol52 getOriginalCol() {
        return originalCol;
    }
