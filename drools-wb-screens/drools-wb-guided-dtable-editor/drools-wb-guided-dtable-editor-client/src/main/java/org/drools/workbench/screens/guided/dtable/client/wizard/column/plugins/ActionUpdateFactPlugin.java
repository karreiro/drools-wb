...
public class ActionUpdateFactPlugin implements DecisionTableColumnGeneratorWizardPlugin {

    private ActionUpdateFactPage page;

    public ActionUpdateFactPlugin( final GuidedDecisionTableColumnWizard wizard,
