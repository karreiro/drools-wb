...
public class AdditionalInfoWizardPageTest {
    ...
    @Before
    public void setup() {
        page = spy( new AdditionalInfoWizardPage() );
    ...
    public void testCanSetupHideColumnCheckBoxWhenEditingColIsNull() throws Exception {
        ...
        assertFalse( page.canSetupHideColumnCheckBox() );
    }
    ...
    public void testCanSetupHideColumnCheckBoxWhenEditingColIsNotNull() throws Exception {
        ...
        assertTrue( page.canSetupHideColumnCheckBox() );
    }
}
