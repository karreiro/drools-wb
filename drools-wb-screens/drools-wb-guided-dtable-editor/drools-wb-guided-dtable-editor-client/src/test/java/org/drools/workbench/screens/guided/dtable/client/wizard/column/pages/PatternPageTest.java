...
public class PatternPageTest {
    ...
    public void testForEachPatternValues() throws Exception {
        ...
        assertEquals( "factType1 boundName1 false", patternValues.get( 0 ) );
        assertEquals( "factType2 boundName2 true", patternValues.get( 1 ) );
    }
    ...
    public void testForEachPatternNames() throws Exception {
        ...
        assertEquals( "factType1 [boundName1]", patternNames.get( 0 ) );
        assertEquals( "negatedPattern factType2 [boundName2]", patternNames.get( 1 ) );
    }
    ...
    public void testCanSetNewFactPatternLabelWhenPatternIsNotANewFactPattern() throws Exception {
        final Pattern52 pattern = pattern( "factType2", "boundName2", true );
    ...
    public void testCanSetNewFactPatternLabelWhenPatternIsANewFactPattern() throws Exception {
        final Pattern52 pattern = pattern( "factType3", "boundName3", true );
    ...
    public void testSetEditingPattern() throws Exception {
        final Pattern52 pattern = pattern( "factType1", "boundName1", false );
    ...
    public void testCurrentPatternNameWhenTheCurrentPatternIsNotNull() throws Exception {
        when( plugin.getEditingPattern() ).thenReturn( pattern( "factType3", "boundName3", true ) );

        final String patternName = page.currentPatternName();

        assertEquals( "negatedPattern factType3 [boundName3]", patternName );
    }
    ...
    public void testCurrentPatternValueWhenTheCurrentPatternIsNotNull() throws Exception {
        ...
        assertEquals( "factType3 boundName3 true", patternValue );
    }
    ...
    private List<Pattern52> fakePatterns() {
        return new ArrayList<Pattern52>() {{
            add( pattern( "factType1", "boundName1", false ) );
            add( pattern( "factType2", "boundName2", true ) );
        }};
    }
