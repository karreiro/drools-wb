...
public class FactPatternConstraintsPageTest {
    ...
    public void testPrepareView() throws Exception {
        ...
        verify( view ).setAvailablePatterns( Arrays.asList( pattern, secondPattern ) );
    }
    ...
    private void testConditionCompletion( boolean conditionsCompleted ) {
        ...
        assertEquals( conditionsCompleted, conditionsDefinedEventCaptor.getValue().getAreConditionsDefined() );
    ...
    public void testGetOperatorCompletionsLiteral() throws Exception {
        ...
        page.getOperatorCompletions( pattern, conditionCol,  callback );
    ...
    public void testSetChosenConditions() throws Exception {
        ...
        page.setChosenConditions( pattern, Arrays.asList( a, b ) );

        assertEquals( 2, conditions.size() );
        assertEquals( a, conditions.get(0) );
        assertEquals( b, conditions.get(1) );
    }
}
