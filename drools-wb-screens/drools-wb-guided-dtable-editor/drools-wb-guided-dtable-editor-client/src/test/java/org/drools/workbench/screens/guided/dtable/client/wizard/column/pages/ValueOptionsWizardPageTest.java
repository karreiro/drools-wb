...
public class ValueOptionsWizardPageTest {
    ...
    public void testNewDefaultValueWidget() throws Exception {
        ...
        verify( factory ).getWidget( pattern52, editingCol, defaultValue );
    }
    ...
    public void testNewLimitedValueWidget() throws Exception {
        ...
        verify( factory ).getWidget( pattern52, limitedEntryConditionCol52, limitedEntryConditionCol52.getValue() );
    }
    ...
    public void testIsFactTypeAnEvent() throws Exception {
        ...
        verify( oracle ).isFactTypeAnEvent( "factType", callback );
    }
